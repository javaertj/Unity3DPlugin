...
import com.ykbjson.lib.baselib.R;
...
public class RoundViewDelegate {
    ...
    private int shadow_L;
    private int shadow_T;
    private int shadow_R;
    private int shadow_B;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        shadow_L = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_shadow_L, 0);
        shadow_T = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_shadow_T, 0);
        shadow_R = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_shadow_R, 0);
        shadow_B = ta.getDimensionPixelSize(R.styleable.RoundTextView_rv_shadow_B, 0);
    ...
    public void setShadow_L(int shadow_L) {
        this.shadow_L = shadow_L;
    }

    public void setShadow_T(int shadow_T) {
        this.shadow_T = shadow_T;
    }

    public void setShadow_R(int shadow_R) {
        this.shadow_R = shadow_R;
    }

    public void setShadow_B(int shadow_B) {
        this.shadow_B = shadow_B;
    }
    ...
    public int getShadow_L() {
        return shadow_L;
    }

    public int getShadow_T() {
        return shadow_T;
    }

    public int getShadow_R() {
        return shadow_R;
    }

    public int getShadow_B() {
        return shadow_B;
    }
...
//              Log.d("AAA", textColors.getColorForState(new int[]{-android.R.attr.state_pressed}, -1) + "");
    ...
    public void onDraw(Canvas canvas) {
        shadowPaint.setShadowLayer(10, 15F, 15F, Color.GRAY);
        shadowRectF.set(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight() + 30);
